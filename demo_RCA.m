...
% different scenarios are explored under the name of "experiments".
% reproducing figures from Karimi-Rouzbahani et al. 
clear;clc;close all
rng('default')
...
Experiment_3_data=[Exp3_model_free_congruent_RC;Exp3_model_free_incongruent_RC;Exp3_1model_based_incongruent_RC;...
